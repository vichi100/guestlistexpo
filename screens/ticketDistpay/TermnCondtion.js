...
export default class TermnCondition extends React.Component {
  static defaultProps = {
    //backgroundColor: "#fff",
      ...
      <View style={styles.container}>
        ...
        >
          ...
          >
            ...
            >
              <Text style={styles.instructions}>Guest list is allowed till 10 PM after that club charges will be applied</Text>
